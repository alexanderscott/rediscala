...
import com.crunchdevelopment.redis.actors.RedisClientActor
import java.net.InetSocketAddress
import scala.concurrent.{Future, ExecutionContext}
import com.crunchdevelopment.redis.protocol.RedisReply
import com.crunchdevelopment.redis.commands.Transactions
