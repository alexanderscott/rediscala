...
import com.crunchdevelopment.redis.commands.Sentinel
import akka.actor.{Props, ActorRef, ActorSystem}
import akka.event.Logging
import com.crunchdevelopment.redis.api.pubsub.{PMessage, Message}
import com.crunchdevelopment.redis.actors.RedisSubscriberActorWithCallback
