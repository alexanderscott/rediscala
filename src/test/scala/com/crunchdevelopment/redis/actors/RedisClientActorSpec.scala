...
import com.crunchdevelopment.redis.api.connection.Ping
import com.crunchdevelopment.redis.api.strings.Get
import com.crunchdevelopment.redis.{Operation, Redis}
